                ...
                <Box width={{xs: '100%', md: '75%'}}>
                    ...
                    {videoDetail?.snippet.tags.map((item, idx) => (
                        <Chip
                            label={item}
                            key={idx}
                            sx={{marginTop: '10px', color:'white', cursor: 'pointer', ml: '10px'}}
                            deleteIcon={<GraphicEq/>}
                            variant='outlined'
                        />
                    ))}
                    <Typography variant='h5'  sx={{color:'white'}} fontWeight='bold' p={2}>
                    ...
                    <Stack direction='row' gap='20px' alignItems='center' py={1} px={2}>
                        <Stack sx={{opacity: 0.7,color:'white'}} direction='row' alignItems='center' gap='3px'>
                            <Visibility/>
